...
- (id)initWithFrame:(CGRect)frame delegate:(id)aDelegate
{
	...
	if (self)
	{
		...
		self.touchPointView = [[HSICrossHairView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 17.0f, 17.0f) color:[UIColor blueColor]];
...
- (void)drawRect:(CGRect)rect
{
	...
	if (showAntialiasingWarning)
	{
		...
		NSLog(@"HSIIntrospect-ARC: *** WARNING: One or more values of this view's frame are non-integer values. This view will likely look blurry. ***");
	}
	else
	{
