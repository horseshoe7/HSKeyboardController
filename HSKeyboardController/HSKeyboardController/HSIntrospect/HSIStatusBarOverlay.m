...
@implementation HSIStatusBarOverlay
...
- (void)tapped
{
	[[NSNotificationCenter defaultCenter] postNotificationName:kHSIIntrospectNotificationStatusBarTapped object:nil];
}
